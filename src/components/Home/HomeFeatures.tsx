            ...
            <div className="image-block">
              <div className="image-1">
                <div className="inner-box overflow-hidden" data-height="600">
                  <img data-speed="0.8" src="/theme/images/resource/feautre1-1.jpg" alt="" />
                </div>
              </div>

              <div className="image-2">
                <div className="inner-box overflow-hidden" data-height="600">
                  <img data-speed="0.8" src="/theme/images/resource/feautre1-2.jpg" alt="" />
                </div>

                <div className="img-text-block">
                  <div className="icon">
                    <img src="/theme/images/icons/marker-pin.png" alt="" />
                  </div>
            ...
            <div className="content-block">
              ...
              <div className="features-list">
                <div className="list-item">
                  <div className="icon">
                    <img src="/theme/images/icons/feature1-icon1.png" alt="" />
                  </div>
                ...
                <div className="list-item">
                  <div className="icon">
                    <img src="/theme/images/icons/feature1-icon2.png" alt="" />
                  </div>
                ...
                <div className="list-item">
                  <div className="icon">
                    <img src="/theme/images/icons/feature1-icon3.png" alt="" />
                  </div>
                ...
                <div className="list-item">
                  <div className="icon">
                    <img src="/theme/images/icons/feature1-icon4.png" alt="" />
                  </div>
        ...
        <div className="feature-block-two">
          <div className="inner-block wow fadeInUp" data-wow-delay="300ms">
            <div className="image-block">
              <div className="image-1">
                <div className="inner-box overflow-hidden" data-height="600">
                  <img data-speed="0.8" src="/theme/images/resource/feautre1-3.jpg" alt="" />
                </div>
              ...
              <div className="image-2">
                <div className="inner-box overflow-hidden" data-height="600">
                  <img data-speed="0.8" src="/theme/images/resource/feautre1-4.jpg" alt="" />
                </div>
              </div>
            </div>
        ...
        <div className="feature-block">
          <div className="inner-block wow fadeInUp" data-wow-delay="400ms">
            <div className="image-block">
              <div className="image-1">
                <div className="inner-box overflow-hidden" data-height="600">
                  <img data-speed="0.8" src="/theme/images/resource/feautre1-5.jpg" alt="" />
                </div>
              </div>

              <div className="image-2">
                <div className="inner-box overflow-hidden" data-height="600">
                  <img data-speed="0.8" src="/theme/images/resource/feautre1-6.jpg" alt="" />
                </div>

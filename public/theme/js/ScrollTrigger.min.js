  ...
  function vb(e, t) {
    if (La(e)) {
      ...
      ;(~r && (e.indexOf('%') > r && (n *= t / 100), (e = e.substr(0, r - 1))),
        (e =
          n +
          (e in R ? R[e] * t : ~e.indexOf('%') ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0)))
    }
    return e
  }
    ...
    if (i) {
      ...
      ;((d = 'scroll' + n.d2),
        X(
          ...
          _,
          n,
          (S && 20 < _) || (!S && (u ? Math.max(Qe[d], Ue[d]) : i.parentNode[d]) <= _ + 1),
        ),
  ...
  var Je,
      ...
      if (!dt || e) {
        ...
        ;(ot && $.sort(),
          ...
          Pt.forEach(function (e) {
            return (
              'max' === e.vars.end &&
              e.setPositions(e.start, Math.max(e.start + 1, Ja(e.scroller, e._dir)))
            )
          }),
    ...
    $ =
      ((ScrollTrigger.prototype.init = function init(M, C) {
        if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), gt)) {
          ...
          if (
            ...
            (c.tweenScroll = c.tweenScroll || { top: hc(be, je), left: hc(be, He) }),
            ...
            ue &&
              ...
              Ie.forEach(function (e) {
                return (
                  Ma(e) && e.target === (me ? Ge.scrollingElement || Ue : be) && (e.smooth = !1)
                )
              }),
              (d = Ma(ue.snapTo)
                ? ue.snapTo
          ...
          ;((Se.previous = function () {
                ...
                if (ie && e && dt) pb(ScrollTrigger, 'scrollEnd', Hb)
                  ...
                  if (
                    ...
                    for (n = oe.parentNode; n && n !== Qe; )
                      (n._pinOffset && ((O -= n._pinOffset), (A -= n._pinOffset)),
                        (n = n.parentNode))
                  ;(f &&
                    ...
                    (v || Q !== Se.progress || pe) &&
                      (C &&
                        !ve &&
                        C.totalProgress(
                          pe && O < -0.001 && !Q ? Je.utils.normalize(O, A, 0) : Q,
                          !0,
                        ),
            ...
            (Se.labelToScroll = function (e) {
              return (
                (C && C.labels && (O || Se.refresh() || O) + (C.labels[e] / C.duration()) * F) || 0
              )
            }),
                    ...
                    a && !tt
                      ? (ve &&
                        ...
                        de &&
                          ...
                          (Pa(Se.callbackAnimation),
                          G ? G.progress(1) : Pa(C, 'reverse' === i ? 1 : !p, 1)))
                      : ve && T && !tt && T(Se))
                }
                if (x) {
      ...
      (ScrollTrigger.register = function register(e) {
        return (
          s || ((Je = e || Ea()), Da() && window.document && ScrollTrigger.enable(), (s = gt)),
          s
        )
      }),
  ...
  function rc(e) {
    ...
    return (
      ...
      (e.onChange = function (e, t, r, n, o) {
        if (
          (At !== l && Qp(), t && f && m(T(n[2] === t ? c + (e.startX - e.x) : m() + t - n[1])), r)
        ) {
          b.offset && Rp()
          var i = o[2] === r,
